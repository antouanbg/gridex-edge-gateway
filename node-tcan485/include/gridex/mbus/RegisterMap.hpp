...
inline constexpr std::uint16_t Quality = 0x0005;
inline constexpr std::uint16_t Uid0 = 0x0006;
inline constexpr std::uint16_t Uid1 = 0x0007;
inline constexpr std::uint16_t Uid2 = 0x0008;
inline constexpr std::uint16_t Uid3 = 0x0009;
inline constexpr std::uint16_t UptimeLow = 0x000A;
inline constexpr std::uint16_t Heartbeat = 0x000B;

inline constexpr std::uint16_t RequestedAddress = 0x0010;
inline constexpr std::uint16_t RequestedNodeType = 0x0011;
inline constexpr std::uint16_t ApplyConfiguration = 0x0012;
inline constexpr std::uint16_t CommandSequence = 0x0013;
inline constexpr std::uint16_t RequestedPowerKwX10 = 0x0014;
inline constexpr std::uint16_t CommandEnable = 0x0015;
...
inline constexpr std::uint16_t MapVersionValue = 0x0002;
